...
Public Class Class_DOC_ITEXT_SHARP
    '    Public Function DOC_ITEXT_SHARP_CREA_FCGF(sNU_SER As String, sOF As String) As String
    ...
    '    Public Function DOC_ITEXT_SHARP_CREA_DHR(sNU_SER As String, sOF As String) As String
