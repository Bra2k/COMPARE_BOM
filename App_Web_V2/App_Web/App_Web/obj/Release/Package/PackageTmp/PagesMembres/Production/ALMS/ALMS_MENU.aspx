...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div id="tabeau" class="row">
        <div class="col-md-4">
            <a href="ADD_MAC_ADRE.aspx" class="btn btn-default">
                <img src="/App_Themes/ICON_COMPARE/computer3.ico" />Entrer des adresses MAC  
            </a>
        </div>
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <a href="GEST_ANML_NC_DRGT" class="btn btn-default">Gérer les anomalies</a>
        </div>
    </div>
