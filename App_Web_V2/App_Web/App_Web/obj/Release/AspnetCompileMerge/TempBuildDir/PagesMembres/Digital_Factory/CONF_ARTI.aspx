...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="tab_CHBX">
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_OF" runat="server" Text="&nbsp;Saisie de l'OF au colisage" ToolTip="Saisir l'OF au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_BL" runat="server" Text="&nbsp;Saisie du BL au colisage" ToolTip="Saisir le N° de BL au colisage (implique aussi une association à un numéro de palette)" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_NU_CART" runat="server" Text="&nbsp;Saisie du numéro de carton au colisage" ToolTip="Saisir le numéro du carton Eolane au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_NU_SER_ECO" runat="server" Text="&nbsp;Saisie du numéro de série Eolane" ToolTip="Saisir le numéro de série Eolane au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_NU_SER_CLIE" runat="server" Text="&nbsp;Saisie du numéro de série Client" ToolTip="Saisir le numéro de série du client au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_NU_CART_SPEC" runat="server" Text="&nbsp;Saisie du numéro de carton spécifique" ToolTip="Saisir le numéro du carton spécifique au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SAI_CD_FNS" runat="server" Text="&nbsp;Saisie du code fournisseur" ToolTip="Saisir le code fournisseur au colisage" /></td></tr>
        <tr>
            <td style="width: 528px"><asp:CheckBox ID="CheckBox_SUIV_NU_SER_ORDR_CROIS" runat="server" Text="Suivi des numéros de série dans l'ordre croissant" ToolTip="Suivi des numéros de série dans l'ordre croissant au colisage" /></td></tr>
    </table>
    ...
    <table class="tab_sous_ensemble">
        ...
        <tr>
            <td><label>Sous-ensemble n°6 associé :</label></td>
...
<%--         <tr>
    ...
    <table class="tab_01">
        ...
        <tr>
            ...
            <td><asp:TextBox ID="TextBox_QT_CART_PALE" runat="server" ToolTip="Quantité maximale de carton contenue dans une palette au colisage" Width="797px">9999</asp:TextBox></td></tr>
        <tr>
    ...
    <table class="tab_02">
        ...
        <tr>
            <td><label>Nom de la vue de recherche du numéro d&#39;ensemble en fonction des numéros de sous-ensemble :</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_VUE_NU_SER_ENSE_SOUS_ENSE" runat="server" Width="790px"></asp:TextBox></td></tr>
        <tr>
            <td><label>WORKFLOW étape 1</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_1" runat="server" Width="790px"></asp:TextBox></td></tr>
        <tr>
            <td><label>WORKFLOW étape 2</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_2" runat="server" Width="790px"></asp:TextBox></td></tr>
        <tr>
            <td><label>WORKFLOW étape 3</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_3" runat="server" Width="790px"></asp:TextBox></td></tr>
        <tr>
            <td><label>WORKFLOW étape 4</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_4" runat="server" Width="790px"></asp:TextBox></td></tr>
        <tr>
            <td><label>WORKFLOW étape 5</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_5" runat="server" Width="790px"></asp:TextBox></td></tr>
         <tr>
            <td><label>WORKFLOW étape 6</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_6" runat="server" Width="790px"></asp:TextBox></td></tr>
         <tr>
            <td><label>WORKFLOW étape 7</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_7" runat="server" Width="790px"></asp:TextBox></td></tr>
          <tr>
            <td><label>WORKFLOW étape 8</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_8" runat="server" Width="790px"></asp:TextBox></td></tr>
          <tr>
            <td><label>WORKFLOW étape 9</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_9" runat="server" Width="790px"></asp:TextBox></td></tr>
          <tr>
            <td><label>WORKFLOW étape 10</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_WF_ETAP_10" runat="server" Width="790px"></asp:TextBox></td></tr>
          <tr>
            <td><label>Opération de la gamme à laquelle on génére impression numéro de série</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_GNRT_IPSO_NU_SER" runat="server" Width="790px"></asp:TextBox></td></tr>
          <tr>
            <td><asp:CheckBox ID="CheckBox_FORM_NU_SER_ECO_OF6INC" runat="server" Text="Format numéro de série Eolane OF6INC" /></td>
          <tr>
            <td><asp:CheckBox ID="CheckBox_VRFC_CHRC_OF_NU_SER_ECO" runat="server" Text="Vérification cohérence OF numero serie eolane" /></td>
          <tr>
            <td><asp:CheckBox ID="CheckBox_VRFC_CHRC_OF_NU_SER_CLIE" runat="server" Text="Vérification cohérence OF par numéro de série" /></td>
          <tr>
            <td><asp:CheckBox ID="CheckBox_SCAN_NU_SER_FIN_OPRT" runat="server" Text="Scan numéro de série fin opération" /></td></tr>
           <tr>
            <td><label>Format du numéro d'UDI</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_FORM_UDI" runat="server" Width="790px"></asp:TextBox></td></tr>
         <tr>
            <td><label>GTIN</label></td>
            <td style="width: 584px"><asp:TextBox ID="TextBox_GTIN" runat="server" Width="790px"></asp:TextBox></td></tr>
         <tr>
            <td>&nbsp;</td>
            <td style="width: 584px">&nbsp;</td></tr>
         <tr>
            <td>&nbsp;</td>
            <td style="width: 584px">&nbsp;</td></tr>
         <tr>
