...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource_JOUR" runat="server" ConnectionString="<%$ ConnectionStrings:SERCELConnectionString %>" SelectCommand="SELECT TOP(1000) [DT_LOG] AS [Date]
