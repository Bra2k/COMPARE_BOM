...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="tableau" class="row">
        <div class="headinfo col-md-3 background-color: red">
            <div id="info" class="row">
                <div class="img-thumbnail col-xs-12">
                    <%--                    <img src='data:image/jpeg;base64, <%: System.Convert.ToBase64String(Session("thumbnailphoto")) %>' alt='photo' class=" img-circle"/>--%>
        ...
        <div id="menu" class="col-md-9 container-fluid">
