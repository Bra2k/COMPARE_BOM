...
Public Class IDCT_PASS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            Else
                If App_Web.Class_COMM_APP_WEB.COMM_APP_WEB_GET_DROI_PAGE($"{Replace(HttpContext.Current.Request.Url.AbsoluteUri, $"http://{LCase(My.Computer.Name)}/PagesMembres/", "~/PagesMembres/")}.aspx",
                                                                         Session("department"),
                                                                         Session("User_Name")) = False Then Response.Redirect("~/PagesMembres/RDRC_PAGE_MEMB.aspx")
            End If
