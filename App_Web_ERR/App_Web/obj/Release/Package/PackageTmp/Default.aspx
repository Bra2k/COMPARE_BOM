...
<%--                        <div id="cont_NDkxMDN8MXw0fDF8MXwwMDJlNjB8MXxGRkZGRkZ8Y3wx">
        ...
        <table class="tab_menu col-md-3"">
                ...
                <tr>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="ALMS_button" ImageUrl="~\App_Themes\ICON_COMPARE\injecter-seringue.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Production/ALMS/ALMS_menu.aspx" /><span>Vers page import ALMS</span></a></td>
                ...
                <tr>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="SAP" ImageUrl="~\App_Themes\ICON_COMPARE\serveur.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Developpement/Fonctions_Class_SAP_DATA.aspx" /><span>Vers page SAP</span></a></td>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="ImageButton1" ImageUrl="~\App_Themes\ICON_COMPARE\tracabilite_ope.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/TCBL_OPRT.aspx" /><span>Vers page traçabilité opération Digital Factory</span></a></td></tr>
