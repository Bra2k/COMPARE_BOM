...
Partial Public Class SiteMaster
    ...
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents Label_ERR_MSG As Global.System.Web.UI.WebControls.Label
    
    '''<summary>
    '''Contrôle Image_LOGO_ECO.
    '''</summary>
    '''<remarks>
    '''Champ généré automatiquement.
    '''Pour modifier, déplacez la déclaration de champ du fichier de concepteur dans le fichier code-behind.
    '''</remarks>
    Protected WithEvents Image_LOGO_ECO As Global.System.Web.UI.WebControls.Image
End Class
