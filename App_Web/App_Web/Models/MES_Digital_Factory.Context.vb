...
Partial Public Class MES_Digital_FactoryEntities1
    Inherits DbContext

    Public Sub New()
        MyBase.New("name=MES_Digital_FactoryEntities1")
    End Sub
    ...
    <DbFunction("MES_Digital_FactoryEntities1", "F_IDCT_PASS")>
    Public Overridable Function F_IDCT_PASS(dT_DEB As Nullable(Of Date), dT_FIN As Nullable(Of Date), [oF] As String, cD_ARTI_ECO As String) As IQueryable(Of F_IDCT_PASS_Result)
        ...
        Dim cD_ARTI_ECOParameter As ObjectParameter = If(cD_ARTI_ECO IsNot Nothing, New ObjectParameter("CD_ARTI_ECO", cD_ARTI_ECO), New ObjectParameter("CD_ARTI_ECO", GetType(String)))
         ...
         Return DirectCast(Me, IObjectContextAdapter).ObjectContext.CreateQuery(Of F_IDCT_PASS_Result)("[MES_Digital_FactoryEntities1].[F_IDCT_PASS](@DT_DEB, @DT_FIN, @OF, @CD_ARTI_ECO)", dT_DEBParameter, dT_FINParameter, oFParameter, cD_ARTI_ECOParameter)
    End Function
