       ...
       <div class="headinfo" style="width: 236px">
        ...
        <br />
            <table style="margin-top: 0px; margin-bottom: 0px; position: relative; top: -222px; left: 313px; height: 298px; width: 676px;">
                <tr>
                    <td style="width: 200px"><asp:ImageButton ID="InBox" runat="server" Height="100px" ImageUrl="~/App_Themes/PIC_CHAR/14740.png" Width="100px" BorderColor="#3333CC" BorderStyle="Solid" BorderWidth="3px" PostBackUrl="~/PagesMembres/Digital_factory/CLSg" /></td>
