...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <link href="App_Themes/CSS/CSS_MediaQuery.css" rel="stylesheet" type="text/css" />
        ...
        <div class="headinfo" style="width: 236px">
           <%--<asp:MultiView ID="MultiView_LOG" runat="server" ActiveViewIndex="0">
                ...
                <table class="tab_infos_con">
                    ...
                    <%--<tr><td><script type="text/javascript" src="http://vivget.com/viv/loader/quotation/locale/FR/pid/12921/rel/nofollow/variant/2/headercolorfont/989000/contentcolortop/002F60/contentcolorfont/FFFFFF/loader.js"></script> <%--<noscript><a href="http://www.viversum.fr/" rel="nofollow">Voyance viversum</a></noscript></td></tr>--%>
                </table>
        ...
        <table class="tab_menu">
            <tr>
                <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Parcel2" runat="server" ImageUrl="~/App_Themes/ICON_COMPARE/parcel2.ico" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_factory/CLSg.aspx" /><span>Vers page colisage</span></a></td>
                <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Ensemble" ImageUrl="~\App_Themes\ICON_COMPARE\ensemble.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/TCBL_ESB_SS_ESB_V2.aspx" /><span>Vers page ensembles</span></a></td>
                <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Imp_STW" ImageUrl="~\App_Themes\ICON_COMPARE\imprimeur_stw.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Provisoire/IMPR_RAPP_TCBL_STW_V2.aspx" /><span>Vers page rapport STW</span></a></td>
            <% If session("samaccountname") = "CE_DIGITEC" Then %>
                <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Etiquette" ImageUrl="~\App_Themes\ICON_COMPARE\etiquette3.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_factory/IMPR_ETIQ_PRN.aspx" /><span>Vers page étiquettes</span></a></td>
                <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Composant2" ImageUrl="~\App_Themes\ICON_COMPARE\composant2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/TCBL_COMP.aspx" /><span>Vers page composants</span></a></td></tr>
            <% End If %>
        </table>
        <% Else If session("department") = "Methode" Then  %>
        <table class="tab_menu">
            <tr>
                <td style="width: 200px;"><a class="info" href="#"><asp:ImageButton ID="Compare_file" ImageUrl="~\App_Themes\ICON_COMPARE\comparer_fichier2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Methodes/Comparaison_BOM.aspx" ImageAlign="Middle" /><span>Vers page compare BOM</span></a></td></tr>
        </table>
        ...
        <table class="tab_menu">
            ...
            <% ElseIf Session("samaccountname") = "SO_GACNO" Then %>
                <tr>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Battery2" ImageUrl="~\App_Themes\ICON_COMPARE\batterie2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Provisoire/TEST_BATT_TUCK.aspx" /><span>Vers page batteries</span></a></td></tr>
        ...
        <% Else If Session("department") = "Expedition" Then %>
            ...
            <% If Session("samaccountname") = "SO_EXPED" %>
                <tr>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Sticker2" ImageUrl="~\App_Themes\ICON_COMPARE\etiquette3.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_factory/IMPR_ETIQ_PRN.aspx" /><span>Vers page étiquettes</span></a></td>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Parcle4" ImageUrl="~\App_Themes\ICON_COMPARE\parcel2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_factory/CLSg.aspx" /><span>Vers page colisage</span></a></td></tr>
            <% Else If Session("samaccountname") = "CE_DERJO" %>
                <tr>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Parcel5" ImageUrl="~\App_Themes\ICON_COMPARE\parcel2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_factory/CLSg.aspx" /><span>Vers page colisage</span></a></td></tr>
            <% End If %>
            </table>
        <% Else %>
            <table class="tab_menu">
                <tr>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Config" ImageUrl="~\App_Themes\ICON_COMPARE/configuration2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Developpement/CFGR_POST.aspx" /><span>Vers page configuration</span></a></td>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Sticker3" ImageUrl="~\App_Themes\ICON_COMPARE\etiquette3.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/IMPR_ETIQ_PRN.aspx" /><span>Vers page étiquettes</span></a></td></tr>
                <tr>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Barcode2" ImageUrl="~\App_Themes\ICON_COMPARE\barcode3.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/CONF_ARTI.aspx" /><span>Vers page articles</span></a></td>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Compare_file2" ImageUrl="~\App_Themes\ICON_COMPARE\comparer_fichier2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Methodes/Comparaison_BOM.aspx" /><span>Vers page compare BOM</span></a></td>
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Log_diaries" ImageUrl="~\App_Themes\ICON_COMPARE\log_diaries4.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Developpement/JOUR_APP.aspx" /><span>Vers page LOGS</span></a></td>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Indic2" ImageUrl="~\App_Themes\ICON_COMPARE\indicateur2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Digital_Factory/IDCT_PASS.aspx" /><span>Vers page indicateur</span></a></td></tr>
                <tr>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Banc_Test" ImageUrl="~\App_Themes\ICON_COMPARE\banc_test.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Production/Test/AJOU_EMPL_MAJ_FICH_BANC_TEST.aspx" /><span>Vers page banc de test</span></a></td>
                    ...
                    <td style="width: 200px"><a class="info" href="#"><asp:ImageButton ID="Battery3" ImageUrl="~\App_Themes\ICON_COMPARE\batterie2.ico" runat="server" Height="100px" Width="100px" PostBackUrl="~/PagesMembres/Provisoire/TEST_BATT_TUCK.aspx" /><span>Vers page batteries</span></a></td></tr>
            </table>
    <% End If %>
    </div>
    </div>
