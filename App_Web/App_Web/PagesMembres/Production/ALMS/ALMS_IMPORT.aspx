    ...
    <asp:MultiView ID="MultiView_ALMS" runat="server" ActiveViewIndex="0">
        <asp:View ID="View_ALMS_DATA_ENTR" runat="server">
            ...
            <table style="width:100%;">
                <tr>
                    <td><label>Sélectionner une date de validation : </label><br />
                        <asp:Calendar ID="Calendar_VAL" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px" SelectedDate="<%# DateTime.Today %>">
                    ...
                    <td><label>Sélectionner une date d'application :</label><br />
                        <asp:Calendar ID="Calendar_APP" runat="server" BackColor="White" BorderColor="#999999" CellPadding="4" DayNameFormat="Shortest" Font-Names="Verdana" Font-Size="8pt" ForeColor="Black" Height="180px" Width="200px" SelectedDate="<%# DateTime.Today %>">
                        <DayHeaderStyle BackColor="#CCCCCC" Font-Bold="True" Font-Size="7pt" />
                        <NextPrevStyle VerticalAlign="Bottom" />
                        <OtherMonthDayStyle ForeColor="#808080" />
                        <SelectedDayStyle BackColor="#666666" Font-Bold="True" ForeColor="White" />
            ...
            <div class="ALMS_upload">
                ...
                <br />
                <asp:FileUpload ID="FileUpload_ALMS" runat="server" BackColor="#002F60" Font-Bold="True" ForeColor="White" BorderColor="Black" BorderStyle="Solid" BorderWidth="2px" Width="1000px" />
            </div>
            <br />
            <div>
